public class StepHash {
    ...
    // Langkah atau interval untuk menanggani sebuah kondisi
    private int step = 1;

    // Konstruktor StepHash
    //sebuah size Ukuran dari array hash table yang kita buat sebagai kelas
    ...
    // value Nilai yang akan disisipkan
    ...
    //Indeks dari nilai yang dicari, atau -1 jika tidak ditemukan
