...
class Mahasiswa {
    ...
    private String jurusan;  // Jurusan Mahasiswa
     ...
     // Data  untuk menginisiasikan objek Mahasiswa.
     // nim   : NIM mahasiswa
     // nama  :  Nama mahasiswa
...
public class DataMahasiswa {
     ...
     // Sebuah return Indeks mahasiswa jika ditemukan, atau -1 jika tidak ditemukan
    ...
    public static int interpolationSearch(ArrayList<Mahasiswa> list, String nimTarget) {
     ...
     // Menampilkan sebuah  tabel data mahasiswa.
